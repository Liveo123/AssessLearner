...
if __name__=="__main__":
    ...
    for cnt in range (0, LEAF_SIZE_RANGE):
        ...
        learner = lrl.BagLearner(dt.DTLearner, kwargs={"leaf_size": cnt}, verbose = False)
    ...
    plt.title('RMSE DTLearner Istanbul')
    plt.ylim(0.000, 0.05)
    plt.show()
    ...
    #plt.xlabel('Leaf Size')
    #plt.title('Correlation DTLearner Istanbul')
    #plt.ylim(0.6, 0.8)
    #plt.show()
